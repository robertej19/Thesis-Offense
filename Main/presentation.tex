...
\vspace{.2cm}
    ...
    \column{0.4\textwidth}
     ...
     \textbf{Overall Normalization}
        ...
        \item Normalizing to prior CLAS result yields 9\% correction, $\sim$ 10\% spread
...
\begin{frame}{Preliminary Cross Section Results}
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item 7 bins in \textit{t} from \textit{t}=0.12 to \textit{t}=1.7 
...
\begin{frame}{Structure Function Extraction (Preliminary)}
 \begin{columns}
        ...
        \column{0.7\textwidth}
        \begin{tikzpicture}
            \node[anchor=south west, inner sep=0] (image) at (0,0) {\includegraphics[width=0.859\textwidth]{lastminute/updated_GK.png}};
...
\begin{frame}{Cross Section t Dependence (Preliminary)}
...
\begin{frame}{Acknowledgements - MIT}
    \begin{columns}
        ...
        \column{0.16\textwidth}
            ...
            \includegraphics[width=0.99\textwidth]{people/milnergroup/seth_loyd.png}
                \column{0.16\textwidth}
            \centering
            ...
            \includegraphics[width=0.99\textwidth]{people/milnergroup/phil.png}
        \end{columns}   
...
\begin{frame}{Acknowledgements - MIT Family }
     \begin{columns}
             \column{0.33\textwidth}
                ...
                \includegraphics[width=0.865\textwidth]{people/people/chairs.png}
