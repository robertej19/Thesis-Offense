           ...
           \column{0.4\textwidth}
                \begin{figure}
                    ...
                    \end{figure} 
                        ...
                        \caption{                       {\myfont{\tiny  [R.G. Milner and R. Ent, Visualzing the Proton (2022)]   }}}
                        %Source  https://home.cern/science/engineering/accelerating-radiofrequency-cavities
...
%\begin{frame}{Correction Factors Determined by Simulations}
%    Bates OSG Pipeline
%\end{frame}
...
%\begin{frame}{Normalizing Flows - Simulation Speedup}
%words
...
\vspace{.2cm}
    ...
    \vspace{.6cm}
        ...
        \item Preliminary work indicates $\sim$ 5\% correction
    \end{itemize}
    \column{0.33\textwidth}
...
%\begin{frame}{Directly Accessing Physics with OMNIFOLD}
%words
